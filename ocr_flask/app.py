...
data={}
report=['UHID','Reg Date','Patient Name :','Ward Name','Sample Detail ','Age','Department','Unit Name',
...
def upload_page():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            #pname=re.search('{}(.*){}'.format("Patient Name", " Ward Name"), extracted_text).group(0)
            pname=(extracted_text.split(start))[1].split(end)[0]
            print("pn",pname)
            for key in report:
            ...
            return render_template('upload.html',
                                   ...
                                   sex=data['Sample Detail '],
                                   age=data['Age'],
                                   report=data['Report entered by'],
                                   lab=data['LAB NUMBER'],
                                   test=data['Test Name ']
